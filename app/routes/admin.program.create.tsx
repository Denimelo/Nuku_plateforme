...
export async function action({ request }: ActionFunctionArgs) {
  ...
  const user = await requireAdmin(request); // Utilisez la même méthode que dans le loader
  if (!user) {
  ...
  console.log("=== CRÉATION PROGRAMME ===");
  ...
  // Vérifier que les dates ne sont pas dans le passé (optionnel)
  ...
  try {
    const result = await programsServerAPI.createProgram(session.token, programData);
    console.log("=== SUCCÈS CRÉATION PROGRAMME ===");
    console.log("Résultat:", result);
    return redirect("/admin/programs?success=program_created");
  } catch (error: any) {
    console.error("=== ERREUR CRÉATION PROGRAMME ===");
    ...
    if (error.message?.includes("validation")) {
      ...
      errorMessage = "Un programme avec ce nom existe déjà.";
...
export default function AdminProgramsCreate() {
  ...
  return (
    <Layout user={user} title="Créer un nouveau programme" navigation={navigation}>
        ...
        <div className="bg-gradient-to-r from-slate-800 to-purple-700 rounded-3xl p-8 text-white relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">Créer un nouveau programme</h1>
                <p className="text-xl text-slate-200">
                  Lancez un programme d'accélération pour vos entrepreneurs
                </p>
              </div>
            </div>
          </div>
          ...
          <Form method="post" className="space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all resize-none"
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                    placeholder="Ex: 50"
                  />
                </div>
                <p className="mt-1 text-xs text-gray-500">
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              <button
                type="button"
                onClick={() => navigate("/admin/programs")}
                className="px-6 py-3 border border-gray-300 rounded-2xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all"
              >
                Annuler
              </button>
              <button
